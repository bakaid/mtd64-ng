...
class ThreadPool
{
	private:
		...
		std::condition_variable work_to_do_; /**< Condition variable to signal avaliable tasks to sleeping workers. */
		std::atomic<bool> stop_; /**< Atomic variable used to thread-safely stop the pool. */
	public:
		/**
		 * Constructor
