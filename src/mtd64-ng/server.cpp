...
void Server::start() {
	...
	if (bind(sock6fd_, reinterpret_cast<struct sockaddr*>(&dns64srv_addr_), sizeof(dns64srv_addr_)) == -1) {
		std::stringstream ss;
