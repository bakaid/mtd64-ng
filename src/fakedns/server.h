...
class Server
{
	...
	private:
		...
		static const short int response_maxlength_ = 512;	/**< Maximum legth of the DNS response packet (UDP payload) */
		
		aaaaMode aaaa_mode_;	/**< AAAA behaviour */
		double aaaa_probability_; /**< AAAA probability when using PROBABILITY behaviour */
