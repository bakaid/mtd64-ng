...
class Query
{
	...
	public:
		 ...
		 */
		Query(uint8_t* data, size_t len, struct sockaddr_in6 sender, socklen_t sender_slen, Server& server);
		
		/**
		 * Copy constructor.
		 * Needed because std::function, but preferably (and usually) optimized out by the compiler.
		 */
